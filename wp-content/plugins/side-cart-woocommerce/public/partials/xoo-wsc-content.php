...
$empty_cart_txt 	= isset( $options['sc-empty-text']) ? $options['sc-empty-text'] : __('Prázdný košík. Napravíte to?','side-cart-woocommerce');
...
<div class="xoo-wsc-body">
	<div class="xoo-wsc-content">
		...
		<?php else: ?>
			...
			<?php
			$subtotal_txt 	= isset($options['sc-subtotal-text']) ? $options['sc-subtotal-text']: __("Celková cena:",'side-cart-woocommerce');
			...
			?>
					...
					<div class="xoo-wsc-product" data-xoo_wsc="<?php echo $cart_item_key; ?>">
						<div class="xoo-wsc-img-col">
							...
							<a href="#" class="xoo-wsc-remove"><?php _e('Odebrat','side-cart-woocommerce'); ?></a>
						</div>
