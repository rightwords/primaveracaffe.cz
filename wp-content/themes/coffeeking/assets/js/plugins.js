...
/*
			var $slide2 = '<div class="zs-layer-2" style="background-image: url(' + this.settings.src2[0] + ')"></div>';
			$slide2.appendTo( $slidesWrap );
*/

			self._promoteChildren();

			$zslayer.css({ 'background-image': "url('" + this.settings.src2[0] + "')" });
			...
			if ( this.settings.arrows == true ) {
				...
				$('<div class="container"><span class="arrow-right">'+this.settings.next+'</span><span class="arrow-left">'+this.settings.prev+'</span></div>').appendTo( $arrowsWrap );
				this.$el.append( $arrowsWrap );

				this.$el.on('click', '.arrow-left', function(e){
					self.prev();
				});

				this.$el.on('click', '.arrow-right', function(e){
					self.next()	;
				});
			}			
			...
			if (this.support) {
				...
				setTimeout(function(){
					...
					//$firstSlide.find('.zs-layer-2').css( { 'opacity': 1.0, 'transform': 'scale('+ 1.2 +', '+ $initzoom + 0.2 +')', 'z-index': 3 } );
		...
		initSingle: function() {
			...
			if (this.support) {
				...
				setTimeout(function(){
					$slide.css( { 'opacity': 1.0, 'transform': 'scale('+this.settings.initzoom+', '+this.settings.initzoom+')', 'z-index': 2 } );
					//$slide.find('.zs-layer-2').css( { 'opacity': 1.0, 'transform': 'scale('+ this.settings.initzoom + 0.2 +', '+ this.settings.initzoom + 0.2 +')', 'z-index': 3 } );					
				}, 50);
			}
		},
